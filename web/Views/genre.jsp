                ...
                <div class="movie-browse-agile">
                    ...
                    <div class="browse-agile-w3ls general-w3ls">
                        <div class="tittle-head">
                            <h4 class="latest-text">Genre: </h4>
                            <div class="container">
                                <div class="agileits-single-top">
                                    <ol class="breadcrumb">
                                        <li><a href="HomeController">Home</a></li>
                                        <li class="active">${genre.genreName}</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul>
                            ...
                            <c:if test="${endPage!=0}">
                                <c:if test="${index_save<=1}">
                                    <li><a class="frist" href="GenreController?index=${index_save}&id=${save}">Prev</a></li>
                                    </c:if>
                                    <c:if test="${index_save>1}">        
                                    <li><a class="frist" href="GenreController?index=${index_save-1}&id=${save}">Prev</a></li>
                                    </c:if>
                                </c:if>
                            <!--number-->
                            <c:if test="${endPage<=5}">
                                <c:forEach begin="1" end="${endPage}" var="i">
                                    ...
                                    <li><a href="GenreController?index=${i}&id=${save}">${i}</a></li>
                            ...
                            <c:if test="${endPage!=0}">
                                <c:if test="${endPage<=index_save}">
                                    <li><a class="last" href="GenreController?index=${endPage}&id=${save}">Next</a></li>
                                    </c:if>
                                    <c:if test="${endPage>index_save}">    
                                    <li><a class="last" href="GenreController?index=${index_save+1}&id=${save}">Next</a></li>
                                    </c:if>
                                </c:if>
                        </ul>
                    </div>
