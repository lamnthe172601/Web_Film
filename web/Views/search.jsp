                            ...
                            <div class="container">
                                <div class="agileits-single-top">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="active">key word: ${save}</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul>
                            ...
                            <c:if test="${endPage!=0}">
                                <c:if test="${index_save<=1}">
                                    <li><a class="frist" href="SearchController?index=${index_save}&Search=${save}">Prev</a></li>
                                    </c:if>
                                    <c:if test="${index_save>1}">        
                                    <li><a class="frist" href="SearchController?index=${index_save-1}&Search=${save}">Prev</a></li>
                                    </c:if>
                                </c:if>
                            <!--number-->
                            <c:if test="${endPage<=5}">
                                <c:forEach begin="1" end="${endPage}" var="i">
                                    ...
                                    <li><a href="SearchController?index=${i}&Search=${save}">${i}</a></li>
                            ...
                            <c:if test="${endPage!=0}">
                                <c:if test="${endPage<=index_save}">
                                    <li><a class="last" href="SearchController?index=${endPage}&Search=${save}">Next</a></li>
                                    </c:if>
                                    <c:if test="${endPage>index_save}">    
                                    <li><a class="last" href="SearchController?index=${index_save+1}&Search=${save}">Next</a></li>
                                    </c:if>
                                </c:if>
                        </ul>
                    </div>
