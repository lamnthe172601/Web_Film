            ...
            <div class="modal-content">
                ...
                <section>
                    <div class="modal-body">
                        ...
                        <div class="w3_login_module" style="display: flex">
                            <img src="${account.img}" alt="alt" style="justify-content: center;border-radius: 50%;width: 200px;height: 200px"/>
                            <table>
                                <tr>
                                    <td>Name:</td>
                                    <td>${account.name}</td>
                        ...
                        <form action="UpdateProfileController" method="post">
                            <button type="submit" style="background-color: orange;color: white;height: 50px;border: 1px solid white;border-radius: 5%">Update Profile</button>    
                        </form>
                    </div>
            </div>
        </section>
