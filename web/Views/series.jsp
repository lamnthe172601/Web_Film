                            ...
                            <ul>
                                ...
                                <c:if test="${endPage!=0}">
                                    <c:if test="${index_save<=1}">
                                        <li><a class="frist" href="SeriesController?index=${index_save}">Prev</a></li>
                                        </c:if>
                                        <c:if test="${index_save>1}">        
                                        <li><a class="frist" href="SeriesController?index=${index_save-1}">Prev</a></li>
                                        </c:if>
                                    </c:if>
                                <!--number-->
                                <c:if test="${endPage<=5}">
                                    <c:forEach begin="1" end="${endPage}" var="i">
                                        ...
                                        <li><a href="SeriesController?index=${i}">${i}</a></li>
                                ...
                                <c:if test="${endPage!=0}">
                                    <c:if test="${endPage<=index_save}">
                                        <li><a class="last" href="SeriesController?index=${endPage}">Next</a></li>
                                        </c:if>
                                        <c:if test="${endPage>index_save}">    
                                        <li><a class="last" href="SeriesController?index=${index_save+1}">Next</a></li>
                                        </c:if>
                                    </c:if>
                            </ul>
                        </div>
